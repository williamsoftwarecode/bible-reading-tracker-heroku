...
@NgModule({
  ...
  declarations: [ AppComponent, CalendarComponent, DatePopulatorComponent, HeaderComponent, DropdownDirective, ReadingDetailsComponent, ReadingDetailsEditComponent ],
